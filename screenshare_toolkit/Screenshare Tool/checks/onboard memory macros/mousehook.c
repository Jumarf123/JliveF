...
bool InstallMouseHook() {
    ...
    printf("[Onboard Memory Macro Scanner] Press the DELETE key to stop the checks for onboard macros at any time. Since this is the final check, the program will close if you press this key.\n");
    printf("[Onboard Memory Macro Scanner] If you click on the console, the hook may freeze and clicks WILL NOT be detected. Click outside the console.\n");
    ...
    printf("If you see \"Autoclicker detected\" message in the console, ban the user.\n");
